...
public final class VerifyUtils {
    private static final String zFilePath = "src/main/java/pers/zr/brownstone/chinesechess/ai/files/verify.txt";

    private static void genVerify() throws IOException {
